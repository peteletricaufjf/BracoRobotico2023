...
void lertabuleiro_aposrobo(){
 ...
 digiralWrite(enable4,HIGH);
  for (byte i = 0; i< mux1.channelCount(); i ++){
    leitura_atual[linha][coluna] = mux1.read(i);
  ...
  for (byte i = 0; i< mux2.channelCount(); i ++){
    leitura_atual[linha][coluna] = mux2.read(i);
  ...
  for (byte i = 0; i< mux3.channelCount(); i ++){
    leitura_atual[linha][coluna] = mux3.read(i);
    //Serial.print("Push button at channel "); Serial.print(i); Serial.print(" is "); Serial.println(data == LOW ? "pressed" : "not pressed");
    if(linha == 7){
      linha = 0;
      coluna++;
  ...
  for (byte i = 0; i< mux4.channelCount(); i ++){
    leitura_atual[linha][coluna] = mux4.read(i);
    //Serial.print("Push button at channel "); Serial.print(i); Serial.print(" is "); Serial.println(data == LOW ? "pressed" : "not pressed");
    if(linha == 7){
      linha = 0;
      coluna++;
